...
let dict = {
    'es': {
        ...
        atMost1MB: 'La imagen cargada debe pesar a lo más 1 MB.',
    ...
    'en': {
        ...
        atMost1MB: 'The image uploaded must be at most 1 MB.',
    ...
    'de': {
        ...
        atMost1MB: 'Das hochgeladene Bild darf höchstens 1 MB groß sein.',
...
export default {
    ...
    atMost1MB(text) {
        return value =>  value && value.size <= 1024*1024 || text || dict[language].atMost1MB;
    },
    maximum4KG(text) {
